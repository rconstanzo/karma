...
static inline double dease_func(double y1, char updwn, double ramp, t_ptr_int rfad)
...
/*static inline void rec_index(long pos,long *rpos,char dir,char diro,long loop,long frmsm) //<-possible todo: prep separate rec..
